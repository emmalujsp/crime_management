...
<div class="container" style="margin-top:30px;">
  <div class="row">
    ...
    <div class="col-sm-10">
     <div class="jumbotron">
	<div class="container">
		<form class="form-horizontal" action="complaint_register.php" method="post" enctype="multipart/form-data" onsubmit="display()">
			<p>New Complaint</p>
			<div class="form-group">
				<label class="control-label col-sm-2">Name: </label>
				<div class="col-sm-10">
					<input type="Text" class="form-control" name="name" size="50%" placeholder="Name">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-4">Complaint Details: </label>
				<div class="col-sm-10">
					<input type="text" class="form-control" size="50%" name="details" placeholder="complaint details">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="control-label col-sm-2">Your Gender: </label>
				<div class="col-sm-10">
					<label><input type="Radio" value="Male" name="gen" size="20%">&nbsp Male</label>
					<label><input type="Radio" value="Female" name="gen" size="20%">&nbsp Female</label>
				</div>
			</div>
				<div class="form-group">
				...
				<div class="form-group">
				<label class="control-label col-sm-4">Criminal Details: </label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="criminal" size="50%" placeholder="Identification mark" required>
				</div>
			</div>
				<div class="form-group">
				<label class="control-label col-sm-2">Identification: </label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="idt" size="50%" placeholder="Identification mark" required>
				</div>
			</div>
			<div class="form-group">
