...
<div class="container" style="margin-top:30px;">
  <div class="row">
	...
	<div class="jumbotron">
		<?php $cid=$_GET['cID'];?>
		<form class="form-horizontal" action="fir_register.php?cID=<?php echo $cid;?>" method="post" enctype="multipart/form-data" onsubmit="display()">
			<h2><p>File FIR</p></h2>
			<div class="form-group">
				<label class="control-label col-sm-2">DETAILS: </label>
				<div class="col-sm-10">
					
					<textarea class="form-control" rows="5" id="comment" name="details" placeholder="FIR Details"></textarea>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2">Address: </label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="address" size="50%" placeholder="Address" required>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="section" size="50%" placeholder="Section" required>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2">D-O-I: </label>
				<div class="col-sm-10">
					<input type="Date" class="form-control" size="50%" name="date" placeholder=" Date of Incident" required>
				</div>
			</div>
					<div class="form-group">
				<label class="control-label col-sm-2">Time: </label>
				<div class="col-sm-10">
					<input type="time" class="form-control" size="50%" name="time" placeholder=" Time of Incident" required>
				</div>
				</div>	
				<h2><p>Criminal Details</p></h2>
					<div class="form-group">
				<label class="control-label col-sm-4">Name of The Criminal: </label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="cname" size="50%" placeholder="Criminal name" required>
				</div>
			</div>
				<div class="form-group">
				<label class="control-label col-sm-2">DETAILS: </label>
				<div class="col-sm-10">
					...
					<textarea class="form-control" rows="5" id="comment" name="cdetails" placeholder="Criminal Details"></textarea>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2">Address: </label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="caddress" size="50%" placeholder="Criminal Address" required>
				</div>
			</div>
				<div class="form-group">
				<label class="control-label col-sm-2">Criminal Type: </label>
				<div class="col-sm-10">
				<table cellpadding="10%">
				<tr>
				<td>
				<input type="radio" class="form-control" name="type"  value="Investigate">
				<label for=ptype-student>Investigate</label>
				</td>
				<td>
				<input type="radio" class="form-control" name="type"  value="Wanted">
				<label for=ptype-student>Wanted</label>
				</td>
				</tr>
				</table>
			...
			<div class="form-group">
				<label class="control-label col-sm-2">Criminal Picture: </label>
				<div class="col-sm-10">
