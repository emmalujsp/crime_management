    ...
    <div class="col-sm-10">
			...
			$us=$_SESSION['name'];
				$conn=new mysqli("localhost","root","","crime"); 
								$sql = mysqli_query($conn, "SELECT * FROM complaint where fir=1");
								...
								while ($row = mysqli_fetch_array($sql))
								{
									...
									echo "<tr>";
											...
											echo "<td>".$row['name']."</td>";
											echo "<td><a class='btn btn-primary' href='admin_complaint_view.php?cID=$row[cmpid]' role='button'>View</a></td>";
										  echo "</tr>";
