    ...
    <div class="col-sm-10">
	   <div class="card">
              <div class="card-header">
                <h3 class="card-title">PAST CASES</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
			...
			$us=$_SESSION['place'];
				$conn=new mysqli("localhost","root","","crime"); 
								$sql = mysqli_query($conn, "SELECT * FROM complaint Where fir='1' AND police='$us'");
								...
								while ($row = mysqli_fetch_array($sql))
								{
									...
									echo "<tr>";
											...
											echo "<td>".$row['name']."</td>";
											echo "<td><a class='btn btn-primary' href='police_pastcomplaint_view.php?cID=$row[cmpid]' role='button'>View</a></td>";
										  echo "</tr>";
