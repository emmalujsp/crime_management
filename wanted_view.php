...
<br><br>
    ...
    <section class="content-header">
      <div class="container-fluid">
          <div class="col-sm-12">
            <h1><font color="white">WANTED CRIMINALS</font></h1>
        </div>
      </div><!-- /.container-fluid -->
    </section>
      ...
      <div class="card card-solid">
        <div class="card-body pb-0">
		  ...
		  $conn=new mysqli("localhost","root","","crime"); 
								$sql = mysqli_query($conn, "SELECT * FROM criminal Where type='Wanted'");
               ...
               echo '   <div class="card-body">';
                ...
                echo '      <div class="col-7">';
                 echo '       <h2 class="lead"><b>'.$row['name'].'</b></h2>';
                  echo '      <p class="text-muted text-sm"><b>About:'.$row['details'].' </p>';
                   ...
                   echo '    <div class="col-5 text-center">';
								$f=$row['fname'];
									echo "<img src='upload/$f' class='img-circle img-fluid' width ='160px' height='160px' >";
                  echo '    </div>';
                  echo '  </div>';
                echo '  </div>';
