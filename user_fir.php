    ...
    <div class="col-sm-10">
			...
			$us=$_SESSION['user'];
				$conn=new mysqli("localhost","root","","crime"); 
								$sql = mysqli_query($conn, "SELECT * FROM fir INNER JOIN complaint ON fir.cmpid = complaint.cmpid WHERE complaint.username='$us'");
								...
								while ($row = mysqli_fetch_array($sql))
								{
									...
									echo "<tr>";
											...
											echo "<td><a class='btn btn-primary' href='user_fir_view.php?fID=$row[FIRid]' role='button'>View</a></td>";
										  echo "</tr>";
